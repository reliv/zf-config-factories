...
======
When practicting dependency injection ZF2, factory classes are tedious and factory closures have performance issues. Try this module to use factories config arrays instead.
